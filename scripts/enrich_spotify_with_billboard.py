...
# Load datasets
spotify_path = "data/dataset-of-10s.csv"
billboard_path = "rwd-billboard-data/data-out/hot-100-current.csv"
...
enriched_df.to_csv("data/enriched/spotify_10s_billboard.csv", index=False)

print("✅ Enrichment complete! Saved to data/enriched/spotify_10s_billboard.csv")
